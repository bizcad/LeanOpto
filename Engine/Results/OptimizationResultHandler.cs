...
namespace QuantConnect.Lean.Engine.Results
{
    ...
    /// </summary>
    public class OptimizationResultHandler : IResultHandler
    {
        ...
        /// </summary>
        public OptimizationResultHandler()
        {
        ...
        public void Run()
        {
            ...
            Log.Trace("OptimizationResultHandler: Ending Thread...");
            _isActive = false;
        }
        ...
        {
            Log.Debug(_algorithm.Time + ": Debug >> " + message);
        }
        ...
        {
            Log.Trace("OptimizationResultHandler.SendStatusUpdate(): Algorithm Status: " + status + " : " + message);
        }
        ...
        {
            DebugMessage("OptimizationResultHandler.OrderEvent(): id:" + newEvent.OrderId + " >> Status:" + newEvent.Status + " >> Fill Price: " + newEvent.FillPrice.ToString("C") + " >> Fill Quantity: " + newEvent.FillQuantity);
        }
        ...
        {
            Log.Trace("OptimizationResultHandler.RuntimeStatistic(): " + key + " : " + value);
        }
        ...
        public void ProcessSynchronousEvents(bool forceProcess = false)
        {
            ...
            while (_algorithm.Notify.Messages.Count > 0 && DateTime.Now < start.AddSeconds(1))
            {
                ...
                if (_algorithm.Notify.Messages.TryDequeue(out message))
                {
                    ...
                    Log.Trace("OptimizationResultHandler.ProcessSynchronousEvents(): Processing Notification...");
                    ...
                    switch (message.GetType().Name)
                    {
                        ...
                        default:
                            ...
                            {
                                Log.Error("OptimizationResultHandler.ProcessSynchronousEvents(): Custom send notification: " + err.Message);
